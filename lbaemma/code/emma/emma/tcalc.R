...
#	RECA will call this function during the modeling process

tcalc=function(k,c)      #T-matrix calculation see Weltje, 1997 Appendix C, k=matrix M, c=weighting Factor                                       
{
