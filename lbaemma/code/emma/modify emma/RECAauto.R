#	please load this function into your R-console by copy and paste
#	required packages, must be installed manually !!!
#	to run RECA call this function in your R-console e.g. Model=RECA(dataset)
#	then input the required parameters when asked


RECAauto=function (x, q = 3, c1 = -6, i = 100, c5 = 0.5) 
{
  ...
  # repeat {								#__repeat-loop for verification of the start model
    ...
    # par(mar = c(5.1, 4.1, 4.1, 2.1), xpd = FALSE, mfrow = c(1, 2))
